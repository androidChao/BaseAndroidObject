...
public final class PullToRefreshListActivity extends NetWorkActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mPullRefreshListView = (IPullToRefreshSwipeListView) findViewById(R.id.pull_refresh_list);
...
//		mPullRefreshListView.setFooterView(R.layout.pull_to_refresh_foot_layout, 120);
		mPullRefreshListView.setOnFooterRefreshListener(new FooterRefreshListener() {
			@Override
			public void footerRefreshing() {
				// TODO Auto-generated method stub
				  PullToRefreshListActivity.this.sendConnection("KJ10008", new String[]{"UserCode","UserPassword","LoginSource"},
