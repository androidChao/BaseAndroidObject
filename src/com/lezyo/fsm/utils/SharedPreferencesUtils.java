...
//    }
//    /**设置未读消息条数*/
//    public static void setMsgNum (Context context , int num) {
//    	SharedPreferencesUtils.setParam(context, "msgNumber", num);  
//    }
//    /**获取未读消息条数*/
//    public static int getMsgNum (Context context ) {
//    	return (Integer)SharedPreferencesUtils.getParam(context, "msgNumber", 0);  
//    }
//保存数据：
